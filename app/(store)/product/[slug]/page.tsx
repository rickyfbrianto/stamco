		...
		<div className="bg-white">
			<div className="container mx-auto py-8 px-8 md:px-0">
				<div className="flex flex-col md:flex-row gap-x-8 gap-y-10">
					...
					<div
						className={`relative min-w-full md:min-w-[20rem] h-[20rem] max-h-[20rem] aspect-square overflow-hidden rounded-lg shadow-lg ${isOutOfStock ? "opacity-50" : ""}
						...
						<div>
							...
							{(product?.stock ?? 0) > 10 ? (
								...
								<div className="text-[.8rem] mb-4">
									<span className="flex gap-2  font-bold text-[--warna-red]">
										<TriangleAlert
											size={16}
											className="text-[--warna-red]"
											strokeWidth={1.5}
										/>{" "}
