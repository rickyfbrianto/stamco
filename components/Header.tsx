            ...
            <div className="container flex items-center gap-8 w-full h-full">
                ...
                <Form action={'/search'} className="flex flex-1 self-end">
                    <div className="flex flex-col flex-1">
                        ...
                        <div className="flex p-2 gap-10 text-[.85rem]">
                            <span>Category</span>
                            {data.map((v) => (
                        ...
                        {user && (
                            <>
                                <Link href={`/cart`} className="relative text-center flex justify-center items-center 
                                    text-white font-bold h-10 w-10 rounded-full border hover:bg-gray-300 transition-colors duration-500">
                                ...
                                <Link href={'/orders'} className="relative text-center flex justify-center items-center 
                                    text-white font-bold h-10 w-10 rounded-full border hover:bg-gray-300 transition-colors duration-500">
                                    <Box size={20} color="#2d4e3d" strokeWidth={1.5} />
                                </Link>
                            </>
                        )}
                        {user ?
